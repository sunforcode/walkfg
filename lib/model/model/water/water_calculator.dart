...
class WaterCalculator {
  ...
  static int calculateActivityWaterIntake({
    ...
    int baseHourlyNeed;
    switch (intensity) {
      case ActivityIntensity.low: baseHourlyNeed = 300; break;
      case ActivityIntensity.moderate: baseHourlyNeed = 500; break;
      case ActivityIntensity.high: baseHourlyNeed = 700; break;
      case ActivityIntensity.veryHigh: baseHourlyNeed = 1000; break;
    }
    
    // 温度调整系数
    double tempFactor = 1.0;
    if (temperature > 30) tempFactor = 1.5;
    else if (temperature > 25) tempFactor = 1.3;
    else if (temperature > 15) tempFactor = 1.0;
    else if (temperature > 5) tempFactor = 0.8;
    else tempFactor = 0.7;
  ...
  static String getWaterIntakeAdvice({
    ...
    if (temperature > 30) {
      switch (intensity) {
        ...
        case ActivityIntensity.veryHigh:
